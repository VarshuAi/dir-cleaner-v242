...
> **Organizes unorganized files into sorted category folders.**  
...
![Language: C++](https://img.shields.io/badge/Language-C++-facc15?style=flat-square&labelColor=0d1117)
...
`dir-cleaner-v242` is a focused, lightweight, and deterministic tool designed for developers and power users. Engineered from first principles with zero bloat, high responsiveness, and clean modular code.

```
┌────────────────────────────────────────────────────────────────────────┐
│  SYSTEM ARCHITECTURE: DIR-CLEANER-V242                                 │
...
Compile and run:
```bash
g++ -O3 main.cpp -o dir-cleaner-v242
./dir-cleaner-v242
```
